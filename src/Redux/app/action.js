...
const fetchCoronaNews = () => (dispatch) => {
    ...
    return axios.get("http://localhost:8081/news?category=Coronavirus")
    .then((res) => {
...
const fetchIndiaNews = () => (dispatch) => {
    ...
    return axios.get("http://localhost:8081/news?sub_category=India")
    .then((res) => {
...
const fetchTopStories = () => (dispatch) => {
    ...
    return axios.get("http://localhost:8081/top_stories/")
    .then((res) => {
